...
async function subscribeUser() {
  ...
  try {
    ...
    var subscriptionResult = await handleFetch("http://pwachatpush-rest-api.azurewebsites.net/" + "subscribe", { method: 'post', mode: 'cors', body: JSON.stringify(sub) });
...
function initialiseApp(pwaUserId) {
  ...
  socketManager.initialize("http://pwachatpush-rest-api.azurewebsites.net/" + 'chat', 'chatHub', pwaUserId);
